                            ...
                            <div className="row">
                                <div className="col-2">
                                    <div className="list-group side-navigation">
                                        ...
                                        {/* <AnchorTag link={`${this.props.match.path}/shop/view`} liClassName="" className="list-group-item list-group-item-action" itemValue="Industry"></AnchorTag> */}
                                        ...
                                        {/* <AnchorTag link={`${this.props.match.path}/shop/product-category/list`} liClassName="" className="list-group-item list-group-item-action" itemValue="Product Group"></AnchorTag> */}
                                        ...
                                        <AnchorTag link={`${this.props.match.path}/shop/invoice/supplierMaster`} className="list-group-item list-group-item-action" itemValue="Supplier Master"></AnchorTag>
