...
import SupplierMaster from "../../../components/customer/SupplierMaster";
    ...
    render(){
        return (
            ...
            <Switch>
                ...
                <Route exact path={`${this.props.match.path}/invoice/supplierMaster`} component={SupplierMaster}/>
                <Route exact path={`${this.props.match.path}/invoice/create`} component={InvoiceForm}/>
                <Route exact path={`${this.props.match.path}/invoice/view/:invoiceId`} component={InvoiceView}/>
            </Switch>
